        ...
        while (ans == -1 && !bfsQue.isEmpty()) {
            ...
            while (curIter-- > 0) {
                ...
                for (int d = 0; d < 4; d++) {
                    ...
                    if (curJump <= k && nx >= 0 && nx < h && ny >= 0 && ny < w && (board[nx][ny] & 1 << curJump) == 0) {
                        board[nx][ny] |= 1 << curJump;
                ...
                for (int d = 4; d < 12; d++) {
                    ...
                    if (curJump < k && nx >= 0 && nx < h && ny >= 0 && ny < w && (board[nx][ny] & 1 << (curJump + 1)) == 0) {
                        board[nx][ny] |= 1 << (curJump + 1);
